 ...
 <?php 
  ...
  <div class="row" style="background: #616A6B  ;"> 
    ...
    <h2 align="center" style="color: #298A08; font-weight: bold;"> REGISTRO </h2>
  ...
  <h6><label> Confirmar contraseña </label></h6>

  <input type="password" id="password_confir" class="campos_ingreso" placeholder="(*) Confirme su contraseña " onkeyup="validador_campo('password_confir','resp_password_confir',4)" maxlength="20" > 

  <div id="resp_password_confir"></div>

   </br>
   </br>
  <center><a class="btn btn-default" onclick="btn_registro_user()"> Registrar </a> 
  </center>
